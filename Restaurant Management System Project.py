...
if __name__=='__main__':
    ...
    Heritage_Cafe=(RMS(restaurant_name,menu))
    ...
    #SubLabel
    tk.Button(window,text="MENU",font=("Times",10),width=23,height=2,command=Heritage_Cafe.display_menu).place(x=120,y=115)
    #Button
    tk.Button(window,text="ORDER",font=("helvtica",10),width=20,height=2,command=Heritage_Cafe.order_process).place(x=120,y=200)
    #Main Window
    window.mainloop()
